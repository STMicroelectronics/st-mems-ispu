...
Note that the current firmware supports ST Edge AI Core 4.0.0 and higher. For previous versions of ST Edge AI Core please refer to the corresponding tags of this repository: [https://github.com/STMicroelectronics/st-mems-ispu/tags](https://github.com/STMicroelectronics/st-mems-ispu/tags).
