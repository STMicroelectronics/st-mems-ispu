...
This ISPU example shows how to use the *ispu_abs_f32()* function of the ISPU DSP package.
...
* Accelerometer x-axis absolute value [g] as float mapped starting from ISPU_DOUT_06_L (1Ch)
* Accelerometer y-axis absolute value [g] as float mapped starting from ISPU_DOUT_08_L (20h)
* Accelerometer z-axis absolute value [g] as float mapped starting from ISPU_DOUT_10_L (24h)
