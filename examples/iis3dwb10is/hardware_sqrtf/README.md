...
This ISPU example shows how to use the square root hardware accelerator by implementing the computation of the norm of the three axes of the accelerometer, configured in continuous mode at 2.5 kHz.
