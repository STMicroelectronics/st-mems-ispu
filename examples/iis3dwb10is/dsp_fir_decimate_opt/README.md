...
This ISPU example shows how to use the *ispu_fir_decimate_f32_opt()* function of the ISPU DSP package.
...
* Decimated accelerometer x-axis [g] as float mapped starting from ISPU_DOUT_06_L (1Ch)
* Decimated accelerometer y-axis [g] as float mapped starting from ISPU_DOUT_08_L (20h)
* Decimated accelerometer z-axis [g] as float mapped starting from ISPU_DOUT_10_L (24h)
