...
static const ucf_line_ext_t shub_conf[] = {
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x21, .data = 0x32 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x44 },
	{ .op = MEMS_UCF_OP_DELAY, .address = 0, .data = 80 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x00 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x00 },
	// write [device 0xBA], 0x11 = 0x12
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x40 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x15, .data = 0xBA },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x16, .data = 0x11 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x17, .data = 0x80 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x21, .data = 0x12 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x44 },
	{ .op = MEMS_UCF_OP_DELAY, .address = 0, .data = 80 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x00 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x00 },
	...
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x17, .data = 0x83 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x00 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x40 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x14, .data = 0x44 },
	{ .op = MEMS_UCF_OP_WRITE, .address = 0x01, .data = 0x00 },
